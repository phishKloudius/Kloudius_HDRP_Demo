...
Shader "SHD_Snake_Monster_Teeth"
{
	Properties
	{
		...
		_EmissionMultiplier("Emission Multiplier", Range( 0 , 100000)) = 1
		_Noise_Tiling("Noise_Tiling", Vector) = (1,1,0,0)
		_Noise_Direction("Noise_Direction", Vector) = (0.1,0.1,0,0)
		_Noise_Speed("Noise_Speed", Range( -5 , 5)) = 1
		_T_TestTeeth_UV("T_TestTeeth_UV", 2D) = "white" {}
		...
		[ASEEnd]_UVPosition04("UV Position 04", Range( -1 , 24)) = -1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_16_0_g7 = floor( _UVPosition01 );
				float temp_output_3_0_g7 = ( packedInput.interp03.xy.x + ( -0.2 * ( temp_output_16_0_g7 % 5.0 ) ) );
				float temp_output_8_0_g7 = ( 0.2 - 0.2 );
				float temp_output_10_0_g7 = ( packedInput.interp03.xy.y + ( -0.2 * floor( ( temp_output_16_0_g7 / 5.0 ) ) ) );
				float temp_output_16_0_g6 = floor( _UVPosition02 );
				float temp_output_3_0_g6 = ( packedInput.interp03.xy.x + ( -0.2 * ( temp_output_16_0_g6 % 5.0 ) ) );
				float temp_output_8_0_g6 = ( 0.2 - 0.2 );
				float temp_output_10_0_g6 = ( packedInput.interp03.xy.y + ( -0.2 * floor( ( temp_output_16_0_g6 / 5.0 ) ) ) );
				float temp_output_16_0_g8 = floor( _UVPosition03 );
				float temp_output_3_0_g8 = ( packedInput.interp03.xy.x + ( -0.2 * ( temp_output_16_0_g8 % 5.0 ) ) );
				float temp_output_8_0_g8 = ( 0.2 - 0.2 );
				float temp_output_10_0_g8 = ( packedInput.interp03.xy.y + ( -0.2 * floor( ( temp_output_16_0_g8 / 5.0 ) ) ) );
				float temp_output_16_0_g9 = floor( _UVPosition04 );
				float temp_output_3_0_g9 = ( packedInput.interp03.xy.x + ( -0.2 * ( temp_output_16_0_g9 % 5.0 ) ) );
				float temp_output_8_0_g9 = ( 0.2 - 0.2 );
				float temp_output_10_0_g9 = ( packedInput.interp03.xy.y + ( -0.2 * floor( ( temp_output_16_0_g9 / 5.0 ) ) ) );
				float4 Emission_OUT145 = ( ( tex2D( _T_TestTeeth_UV, texCoord143 ) * saturate( ( ( ( ( ( step( temp_output_3_0_g7 , 0.2 ) - step( temp_output_3_0_g7 , temp_output_8_0_g7 ) ) * ( step( temp_output_10_0_g7 , 0.2 ) - step( temp_output_10_0_g7 , temp_output_8_0_g7 ) ) ) + ( ( step( temp_output_3_0_g6 , 0.2 ) - step( temp_output_3_0_g6 , temp_output_8_0_g6 ) ) * ( step( temp_output_10_0_g6 , 0.2 ) - step( temp_output_10_0_g6 , temp_output_8_0_g6 ) ) ) ) + ( ( step( temp_output_3_0_g8 , 0.2 ) - step( temp_output_3_0_g8 , temp_output_8_0_g8 ) ) * ( step( temp_output_10_0_g8 , 0.2 ) - step( temp_output_10_0_g8 , temp_output_8_0_g8 ) ) ) ) + ( ( step( temp_output_3_0_g9 , 0.2 ) - step( temp_output_3_0_g9 , temp_output_8_0_g9 ) ) * ( step( temp_output_10_0_g9 , 0.2 ) - step( temp_output_10_0_g9 , temp_output_8_0_g9 ) ) ) ) ) ) * _EmissionMultiplier );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float temp_output_16_0_g7 = floor( _UVPosition01 );
				float temp_output_3_0_g7 = ( packedInput.ase_texcoord.zw.x + ( -0.2 * ( temp_output_16_0_g7 % 5.0 ) ) );
				float temp_output_8_0_g7 = ( 0.2 - 0.2 );
				float temp_output_10_0_g7 = ( packedInput.ase_texcoord.zw.y + ( -0.2 * floor( ( temp_output_16_0_g7 / 5.0 ) ) ) );
				float temp_output_16_0_g6 = floor( _UVPosition02 );
				float temp_output_3_0_g6 = ( packedInput.ase_texcoord.zw.x + ( -0.2 * ( temp_output_16_0_g6 % 5.0 ) ) );
				float temp_output_8_0_g6 = ( 0.2 - 0.2 );
				float temp_output_10_0_g6 = ( packedInput.ase_texcoord.zw.y + ( -0.2 * floor( ( temp_output_16_0_g6 / 5.0 ) ) ) );
				float temp_output_16_0_g8 = floor( _UVPosition03 );
				float temp_output_3_0_g8 = ( packedInput.ase_texcoord.zw.x + ( -0.2 * ( temp_output_16_0_g8 % 5.0 ) ) );
				float temp_output_8_0_g8 = ( 0.2 - 0.2 );
				float temp_output_10_0_g8 = ( packedInput.ase_texcoord.zw.y + ( -0.2 * floor( ( temp_output_16_0_g8 / 5.0 ) ) ) );
				float temp_output_16_0_g9 = floor( _UVPosition04 );
				float temp_output_3_0_g9 = ( packedInput.ase_texcoord.zw.x + ( -0.2 * ( temp_output_16_0_g9 % 5.0 ) ) );
				float temp_output_8_0_g9 = ( 0.2 - 0.2 );
				float temp_output_10_0_g9 = ( packedInput.ase_texcoord.zw.y + ( -0.2 * floor( ( temp_output_16_0_g9 / 5.0 ) ) ) );
				float4 Emission_OUT145 = ( ( tex2D( _T_TestTeeth_UV, texCoord143 ) * saturate( ( ( ( ( ( step( temp_output_3_0_g7 , 0.2 ) - step( temp_output_3_0_g7 , temp_output_8_0_g7 ) ) * ( step( temp_output_10_0_g7 , 0.2 ) - step( temp_output_10_0_g7 , temp_output_8_0_g7 ) ) ) + ( ( step( temp_output_3_0_g6 , 0.2 ) - step( temp_output_3_0_g6 , temp_output_8_0_g6 ) ) * ( step( temp_output_10_0_g6 , 0.2 ) - step( temp_output_10_0_g6 , temp_output_8_0_g6 ) ) ) ) + ( ( step( temp_output_3_0_g8 , 0.2 ) - step( temp_output_3_0_g8 , temp_output_8_0_g8 ) ) * ( step( temp_output_10_0_g8 , 0.2 ) - step( temp_output_10_0_g8 , temp_output_8_0_g8 ) ) ) ) + ( ( step( temp_output_3_0_g9 , 0.2 ) - step( temp_output_3_0_g9 , temp_output_8_0_g9 ) ) * ( step( temp_output_10_0_g9 , 0.2 ) - step( temp_output_10_0_g9 , temp_output_8_0_g9 ) ) ) ) ) ) * _EmissionMultiplier );
...
/*ASEBEGIN
Version=18934
2599;805.6667;1408;897;3818.715;-671.6198;2.61412;True;False
...
Node;AmplifyShaderEditor.FunctionNode;125;-2516.951,2298.376;Inherit;False;Function_UV_Position;1;;6;65ceb6a2f0dce804287fb7bd4d904a63;0;1;26;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;128;-2510.031,2042.071;Inherit;False;Function_UV_Position;1;;7;65ceb6a2f0dce804287fb7bd4d904a63;0;1;26;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;140;-1661.041,1872.932;Inherit;False;Property;_Noise_Speed;Noise_Speed;8;0;Create;True;0;0;0;False;0;False;1;1;-5;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;139;-1661.43,1795.839;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;131;-2456.602,2467.988;Inherit;False;Function_UV_Position;1;;8;65ceb6a2f0dce804287fb7bd4d904a63;0;1;26;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;138;-1443.791,1664.058;Inherit;False;Property;_Noise_Direction;Noise_Direction;7;0;Create;True;0;0;0;False;0;False;0.1,0.1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;-1410.537,1797.662;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;132;-2440.773,2573.718;Inherit;False;Function_UV_Position;1;;9;65ceb6a2f0dce804287fb7bd4d904a63;0;1;26;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;142;-1190.209,1747.683;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0.1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;144;-1198.088,1578.547;Inherit;False;Property;_Noise_Tiling;Noise_Tiling;6;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;143;-976.4518,1727.885;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;25;-664.2993,1694.392;Inherit;True;Property;_T_TestTeeth_UV;T_TestTeeth_UV;9;0;Create;True;0;0;0;False;0;False;-1;f133c63b83b3fa34a92a093f39a0a62a;409c11bd86f54e64a89d16f8bdb26328;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-222.3973,2090.113;Inherit;False;Property;_EmissionMultiplier;Emission Multiplier;5;0;Create;True;0;0;0;False;0;False;1;1;0;100000;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;146;-956.7766,116.5637;Inherit;False;145;Emission_OUT;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;13;-446.2668,-193.8667;Inherit;True;Property;_AlbedoMap;Albedo Map;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;12;-731.1663,-23.36669;Inherit;True;Property;_NormalMap;Normal Map;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;11;-445.5668,67.73331;Inherit;True;Property;_MaskMap;Mask Map;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B7604589F65FBCD6F13ABBAC2B00BEC2FFCA6A7C