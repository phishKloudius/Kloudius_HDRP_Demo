	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float dotResult4 = dot( packedInput.ase_normal , -_DirectionalLightDatas[0].forward );
				float3 temp_cast_0 = (( ( dotResult4 * 0.5 ) + 0.5 )).xxx;
...
/*ASEBEGIN
Version=18934
-1913;6;1920;1013;1035.974;382.7462;1;True;True
Node;AmplifyShaderEditor.DotProductOpNode;4;-348.9736,140.2538;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;5;-696.9736,319.2538;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalVertexDataNode;14;-603.9736,-10.74622;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-110.9736,218.2538;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-240.9736,423.2538;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;46.02637,248.2538;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=4ACC224B63616CFC7B069CD2FB15C6C6252F7B85