	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 objectSpaceLightDir = mul( GetWorldToObjectMatrix(), -_DirectionalLightDatas[0].forward ).xyz;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 objectSpaceLightDir = packedInput.ase_texcoord1.xyz;
				float dotResult10 = dot( packedInput.ase_normal , objectSpaceLightDir );
				float temp_output_14_0 = ( ( dotResult10 * 0.5 ) + 0.5 );
				float4 appendResult15 = (float4(temp_output_14_0 , 0.5 , 0.0 , 0.0));
				
				surfaceDescription.Color = tex2D( _TextureSample0, appendResult15.xy ).rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 objectSpaceLightDir = mul( GetWorldToObjectMatrix(), -_DirectionalLightDatas[0].forward ).xyz;
				o.ase_texcoord.xyz = objectSpaceLightDir;
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 objectSpaceLightDir = packedInput.ase_texcoord.xyz;
				float dotResult10 = dot( packedInput.ase_normal , objectSpaceLightDir );
				float temp_output_14_0 = ( ( dotResult10 * 0.5 ) + 0.5 );
				float4 appendResult15 = (float4(temp_output_14_0 , 0.5 , 0.0 , 0.0));
...
/*ASEBEGIN
Version=18934
-1913;18;1920;1001;2083.707;309.2674;1;True;True
Node;AmplifyShaderEditor.SamplerNode;8;-92.27687,13.02508;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;d0fc0f28ba0f3464abf4e631623e420f;d0fc0f28ba0f3464abf4e631623e420f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ObjSpaceLightDirHlpNode;17;-1466.707,380.7326;Inherit;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ClampOpNode;16;-576.9551,131.0487;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;15;-378.5358,355.3627;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;14;-774.9178,267.2432;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;11;-1533.918,99.24316;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-932.9182,106.2432;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;10;-1173.918,73.24318;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;9;-1365.918,-159.7568;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-1032.918,290.2432;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AA4E7A469223A3FF6755A17A31606DB57FFD7F48