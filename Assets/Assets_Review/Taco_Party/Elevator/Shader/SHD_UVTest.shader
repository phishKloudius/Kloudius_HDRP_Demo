...
Shader "SHD_UVTest"
{
	Properties
	{
		...
		_distance("distance", Range( -1 , 1)) = 0.05
		_transition_range("transition_range", Range( 0 , 5)) = 0.1
		_Noise_Mul("Noise_Mul", Range( 0 , 5)) = 1
		[ASEEnd]_Noise_Scale("Noise_Scale", Range( 0 , 10)) = 5
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_30_0 = ( _mid_point + _distance );
				float smoothstepResult21 = smoothstep( ( temp_output_30_0 + _transition_range ) , temp_output_30_0 , packedInput.ase_texcoord5.xyz.y);
				float temp_output_33_0 = ( _mid_point + -_distance );
				float smoothstepResult15 = smoothstep( ( temp_output_33_0 + -_transition_range ) , temp_output_33_0 , packedInput.ase_texcoord5.xyz.y);
				float temp_output_26_0 = ( smoothstepResult21 * smoothstepResult15 );
				float2 texCoord35 = packedInput.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float simplePerlin2D34 = snoise( texCoord35*_Noise_Scale );
				simplePerlin2D34 = simplePerlin2D34*0.5 + 0.5;
				float4 temp_cast_0 = (simplePerlin2D34).xxxx;
				float4 temp_cast_1 = (( 1.0 - temp_output_26_0 )).xxxx;
				
				surfaceDescription.Albedo = saturate( ( temp_output_26_0 + ( ( ( temp_output_26_0 * CalculateContrast(2.0,temp_cast_0) ) - temp_cast_1 ) * _Noise_Mul ) ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float temp_output_30_0 = ( _mid_point + _distance );
				float smoothstepResult21 = smoothstep( ( temp_output_30_0 + _transition_range ) , temp_output_30_0 , packedInput.ase_texcoord.xyz.y);
				float temp_output_33_0 = ( _mid_point + -_distance );
				float smoothstepResult15 = smoothstep( ( temp_output_33_0 + -_transition_range ) , temp_output_33_0 , packedInput.ase_texcoord.xyz.y);
				float temp_output_26_0 = ( smoothstepResult21 * smoothstepResult15 );
				float2 texCoord35 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float simplePerlin2D34 = snoise( texCoord35*_Noise_Scale );
				simplePerlin2D34 = simplePerlin2D34*0.5 + 0.5;
				float4 temp_cast_0 = (simplePerlin2D34).xxxx;
				float4 temp_cast_1 = (( 1.0 - temp_output_26_0 )).xxxx;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float temp_output_30_0 = ( _mid_point + _distance );
				float smoothstepResult21 = smoothstep( ( temp_output_30_0 + _transition_range ) , temp_output_30_0 , packedInput.ase_texcoord7.xyz.y);
				float temp_output_33_0 = ( _mid_point + -_distance );
				float smoothstepResult15 = smoothstep( ( temp_output_33_0 + -_transition_range ) , temp_output_33_0 , packedInput.ase_texcoord7.xyz.y);
				float temp_output_26_0 = ( smoothstepResult21 * smoothstepResult15 );
				float2 texCoord35 = packedInput.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float simplePerlin2D34 = snoise( texCoord35*_Noise_Scale );
				simplePerlin2D34 = simplePerlin2D34*0.5 + 0.5;
				float4 temp_cast_0 = (simplePerlin2D34).xxxx;
				float4 temp_cast_1 = (( 1.0 - temp_output_26_0 )).xxxx;
...
/*ASEBEGIN
Version=18934
2560;728.6667;1920;1059;-44.55042;309.1075;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;29;-1571.381,109.1071;Inherit;False;Property;_distance;distance;1;0;Create;True;0;0;0;False;0;False;0.05;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-1486.414,-136.2011;Inherit;False;Property;_mid_point;mid_point;0;0;Create;True;0;0;0;False;0;False;0;0;-5;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1259.445,308.9128;Inherit;False;Property;_transition_range;transition_range;2;0;Create;True;0;0;0;False;0;False;0.1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;31;-1213.001,208.3705;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;27;-922.7149,296.8423;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;33;-1022.337,197.1339;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-919.9523,-301.3904;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;25;-712.0687,-211.5918;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-773.0505,193.4939;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-19.69238,478.8212;Inherit;False;Property;_Noise_Scale;Noise_Scale;4;0;Create;True;0;0;0;False;0;False;5;10;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;35;79.169,275.8186;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PosVertexDataNode;11;-1580.397,-401.5931;Inherit;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;21;-507.0421,-368.4681;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;411.5761,561.475;Inherit;False;Constant;_Noise_Contrast;Noise_Contrast;4;0;Create;True;0;0;0;False;0;False;2;5;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;34;345.6693,256.3183;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;15;-533.8112,227.832;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;575.3334,-139.5908;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleContrastOpNode;42;653.9857,260.4362;Inherit;False;2;1;COLOR;0,0,0,0;False;0;FLOAT;7.65;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;36;921.5108,209.0892;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;901.5288,-34.6963;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;44;1291.149,290.6458;Inherit;False;Property;_Noise_Mul;Noise_Mul;3;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;38;1153.388,25.42379;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;1462.299,61.73431;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;40;1663.166,-142.7857;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;37;1812.346,-143.1016;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=ED4A7E17C8C063C7196DE4BA72E9C4A0B8BB66A8